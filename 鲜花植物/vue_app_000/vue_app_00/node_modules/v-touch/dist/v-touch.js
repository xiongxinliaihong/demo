...
function init(el, _ref) {
  ...
  el.eEnd = function (e) {
    ...
    if (e.type === MOUSE_UP) {
      Object(utils["off"])(document, MOUSE_MOVE, el.eMove);
      Object(utils["off"])(document, MOUSE_UP, el.eEnd);
    }
  ...
  el.eStart = function (e) {
    ...
    if (isMouseDown) {
      ...
      Object(utils["on"])(document, MOUSE_MOVE, el.eMove);
      Object(utils["on"])(document, MOUSE_UP, el.eEnd);
    }
  ...
  Object(utils["on"])(el, EVENTS.start, el.eStart);
  Object(utils["on"])(el, EVENTS.move, el.eMove);
  Object(utils["on"])(el, EVENTS.end, el.eEnd);
  Object(utils["on"])(el, 'click', el.eClick);
}

function destroy(el) {
  Object(utils["off"])(el, EVENTS.start, el.eStart);
  Object(utils["off"])(el, EVENTS.move, el.eMove);
  Object(utils["off"])(el, EVENTS.end, el.eEnd);
  Object(utils["off"])(el, 'click', el.eClick);
}
...
/* harmony default export */ var lib = __webpack_exports__["default"] = (VTouch);
